def frequencyAnalysis(text, num):
    ...
    for letter in text:
        if letter.isalpha():
            occurances[letter] = 1 + occurances.get(letter, 0)
        else:
            print("Non-alphabetic character found: ", letter)
    print(occurances)
...
if __name__ == '__main__':
    ...
    replaced = int (num)
    print(frequencyAnalysis(text.upper(), replaced))


    while inp.isalnum() and inp.upper() != 'EXIT':
